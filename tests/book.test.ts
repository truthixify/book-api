...
describe('POST /api/book', () => {
    it('should create a new book', async () => {
        const newBook = {
            ...
            "description": "A novel set in the Roaring Twenties, The Great Gatsby explores themes of decadence, idealism, resistance to change, social upheaval, and excess, creating a portrait of the Jazz Age or the era of the New York elite.",
